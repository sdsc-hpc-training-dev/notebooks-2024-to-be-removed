...
| Chapter 7: Pattern Matching with Regular Expressions | pyperclip, regular expressions/re|patterrns, text processing, webscraping|                  |
| Chapter 8: Input Validation | pyinputplus          |input/output, input validation, keys, keywords|               |
| Chapter 9: Reading and Writing Files | pathlib, os, shelve, pprint, myCats|file processing, reading, writing|                   |
